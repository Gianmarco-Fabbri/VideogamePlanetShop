...
create table ABBONAMENTO (
     ...
     durata numeric(12) not null,
     prezzo numeric(2,2) not null,
...
create table ACQUIRENTE (
     ...
     puntiSconto numeric(10) not null,
...
create table ANNUNCIO (
     ...
     punti_prodotto numeric(4) not null,
...
create table CASA_PRODUTTRICE (
     idCasaProduttrice -- Index attribute not implemented -- not null,
     constraint ID_CASA_PRODUTTRICE_ID primary key (idCasaProduttrice));

create table codice (
     idCasaProduttrice -- Index attribute not implemented -- not null,
     numeroGenerazione numeric(10) not null,
     codice numeric(10) not null,
...
create table Com_codice (
     idCasaProduttrice -- Index attribute not implemented -- not null,
     numeroGenerazione numeric(10) not null,
     Com_codice numeric(10) not null,
...
create table METODO_PAGAMENTO (
     ...
     codCarta numeric(20) not null,
     scadenza date not null,
     e_mail char(1) not null,
     Pos_e_mail char(1) not null,
...
create table PRODOTTO (
     ...
     codice numeric(10) not null,
     CONSOLE numeric(10),
     ACCESSORIO numeric(10),
     GIOCO numeric(10),
     constraint ID_PRODOTTO_ID primary key (codice));

create table RECENSIONE (
     Compratore_e_mail char(1) not null,
     Venditore_e_mail char(1) not null,
